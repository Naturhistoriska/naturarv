...
public class AboutPageText {
  ...
  private final static String WHAT_IS_NATURARV_EN = "You can use this search portal to find information about specimens "
  ...
  private final static String WHAT_IS_NATURARV_SV = "På Naturarv kan du söka information om föremål i "
  ...
  private final static String WHAT_IS_NATURARV_SUB_EN = "The target audience is primarily collections-based researchers and museum staff, "
  ...
  private final static String WHAT_IS_NATURARV_SUB_SV = "Naturarv vänder sig i första hand till forskare och personal "
  ...
  private final static String PART_INFRASTRUCTURE_SV = "Arbetet med att bygga upp en digital infrastruktur för Sveriges naturhistoriska "
  ...
  private final static String PART_INFRASTRUCTURE_EN = "Efforts to build a digital infrastructure for Swedish natural history collections "
  ...
  private final static String PART_INFRASTRUCTURE_SUB_EN = "Naturarv is intended to eventually contain information from all Swedish institutions "
  ...
  private final static String PART_INFRASTRUCTURE_SUB_SV = "Förhoppningen är att Naturarv så småningom ska innehålla information från alla svenska "
  ...
  private final static String DEVELOPMENT_TEXT_SV = "Den tekniska utvecklingen av komponenterna bakom Naturarv sker inom ramen för DINA-projektet i "
  ...
  private final static String DEVELOPMENT_TEXT_EN = "The development of Naturarv components has taken place within the larger context of DINA project "
  ...
  private final static String FINANCIAL_SUPPORT_TEXT_SV = "DINA-projektet stöds av de samarbetande institutionerna, Svenska Artprojektet, SLU och av Svenska LifeWatch.";
  private final static String FINANCIAL_SUPPORT_TEXT_EN = "The DINA project is supported by participating institutions and project funding by the Swedish "
  ...
  public String getWhatIsNaturarvSub(boolean isSwedish) {
    return isSwedish ? WHAT_IS_NATURARV_SUB_SV : WHAT_IS_NATURARV_SUB_EN;
  }
  
  public String getInfrastrcutureText(boolean isSwedish) {
    return isSwedish ? PART_INFRASTRUCTURE_SV : PART_INFRASTRUCTURE_EN;
  }
  ...
  public String getDevelopmentText(boolean isSwedish) {
    return isSwedish ? DEVELOPMENT_TEXT_SV : DEVELOPMENT_TEXT_EN;
  }
  
  public String getFinancialSupportText(boolean isSwedish) {
    return isSwedish ? FINANCIAL_SUPPORT_TEXT_SV : FINANCIAL_SUPPORT_TEXT_EN;
  }
